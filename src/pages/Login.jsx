...
const Login = ({ onLogin, onSwitch }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (email === 'admin@thinkgrid.com' && password === 'tg2026') {
            ...
            setError('Invalid credentials. Use admin@thinkgrid.com / tg2026');
        }
    };
    ...
    return (
        <div className="auth-page">
            ...
            <div className="auth-card-new">
                ...
                <form className="auth-form-new" onSubmit={handleSubmit}>
                    ...
                    <div className="auth-field">
                        ...
                        <div className="auth-input-line">
                            <input
                                type="email"
                                placeholder="admin@thinkgrid.com"
                                value={email}
                ...
                <p className="auth-demo-hint">Demo: admin@thinkgrid.com / tg2026</p>
            </div>
        </div>
    );
};
